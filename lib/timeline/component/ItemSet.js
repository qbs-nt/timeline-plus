 ...
 */
  ...
  _create() {
    ...
    if (this.options.rtl) {
      ...
      this.groupHammer = new Hammer(this.body.dom.rightContainer,{domEvents: true});
    } else {
      // this.groupHammer = new Hammer(this.body.dom.leftContainer);
      this.groupHammer = new Hammer(this.body.dom.leftContainer,{domEvents: true});
    }
  ...
  _onGroupClick(event) {
    const group = this.groupFromTarget(event);
    console.log('ItemSet._onGroupClick', {group, event})
    setTimeout(() => {
      console.log('ItemSet._onGroupClick -> timeout', {group, event})
